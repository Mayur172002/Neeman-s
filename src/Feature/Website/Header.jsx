...
import './Style.css'
import { setSearch } from '../Admin/Slice/ProductSlice'
import { Get_CartItem, } from './Slice/CartSlice'
...
function Header() {
    ...
    if (UserDatafind.length > 0) {
        totalQuantity = UserDatafind.reduce((total, item) => total + item.quantity, 0)
    }
                ...
                <nav className="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
                    <div className="container ">
                        <NavLink className="navbar-brand" to="/">
                            <svg width="250" height="42" viewBox="0 0 404 42" fill="white" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <ul className="navbar-nav ml-auto">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    {/* <div className="dropdown-menu" aria-labelledby="dropdown04">
                                            <Link className="dropdown-item" to="/single_product">Single Product</Link>
                                            <NavLink className="dropdown-item" to="/cart">Cart</NavLink>
                                            <NavLink className="dropdown-item" to="/checkout">Checkout</NavLink>
                                        </div> */}
                                </li>
                                {
                                    categories && categories.slice(0, 2).map((value, index) => {
                                        return (
                                            <li key={index} className="nav-item"><NavLink to={"/view_categories/" + value.id} className="nav-link" activeClassName="active">{value.name}</NavLink></li>
                                        )
                                    })
                                }
                                <li className="nav-item dropdown">
                                    <NavLink className="nav-link dropdown-toggle" to="/about" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About</NavLink>
                                    <div className="dropdown-menu" aria-labelledby="dropdown04">
                                ...
                                <li className="nav-item">
                                    <span id='searchToggle' className="nav-link" style={{ cursor: "pointer" }}>
                                        <i class="fa-solid fa-magnifying-glass mr-2" style={{ fontSize: "12px", }}></i>
                                        Search</span>
                                </li>
                                <li className="nav-item">
                                    <span id='searchToggle' className="nav-link" style={{ cursor: "pointer" }}>
                                        <svg width="17" height="17" class="aish250" className='mr-2' viewBox="0 0 20 20" fill="none" xmlns="">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.0246 0.999761V0.999756L3.02186 0.999766C2.72146 1.00086 2.42386 1.09183 2.17384 1.26692C1.92307 1.44254 1.72996 1.69663 1.63665 1.99839L1.63657 1.99865L0.379598 6.0684C0.351704 6.15872 0.341493 6.25216 0.348161 6.344L0.392626 7.8315C0.395756 8.76597 0.768323 9.66148 1.42932 10.3225C1.54213 10.4353 1.66177 10.5397 1.78727 10.6353V17.1174C1.78727 17.5316 2.12306 17.8674 2.53727 17.8674H13.8523C13.4693 17.4383 13.0695 16.9331 12.7111 16.3674H3.28727V11.3C3.49852 11.3391 3.71431 11.3592 3.93218 11.3592C4.87093 11.3592 5.77123 10.9863 6.43503 10.3225C6.53757 10.2199 6.63316 10.1118 6.72152 9.99867C6.80988 10.1118 6.90549 10.22 7.00805 10.3225C7.67185 10.9863 8.57215 11.3593 9.5109 11.3593C10.4497 11.3593 11.35 10.9863 12.0138 10.3225C12.1164 10.2199 12.2121 10.1116 12.3005 9.99836C12.3194 10.0224 12.3385 10.0463 12.3579 10.0699C12.4599 9.93107 12.5704 9.79837 12.6892 9.67276C12.9212 9.42734 13.1788 9.21519 13.4553 9.0392C13.1941 8.68902 13.0506 8.26175 13.0506 7.81968V7.03973H17.1602L17.1303 7.7899C17.1299 7.79982 17.1297 7.80975 17.1297 7.81968C17.1297 8.12922 17.0594 8.43149 16.9275 8.70513C17.3909 8.88974 17.8212 9.16505 18.1943 9.52051C18.475 9.00825 18.6271 8.42979 18.6297 7.83546L18.6883 6.36095C18.6922 6.26345 18.6773 6.16955 18.6468 6.08276L18.6426 6.06883L17.3883 1.99907L17.3881 1.99838C17.2945 1.69573 17.1005 1.44106 16.8487 1.2654C16.5977 1.09027 16.2989 0.999815 15.9976 0.999761H15.9975H3.0246ZM11.5505 7.03973H7.47175V7.81963L7.4716 7.85257C7.48011 8.3816 7.69397 8.88715 8.06871 9.26189C8.4512 9.64438 8.96998 9.85927 9.5109 9.85927C10.0518 9.85927 10.5706 9.64438 10.9531 9.26189C11.3356 8.87939 11.5505 8.36062 11.5505 7.81969V7.03973ZM5.97133 7.03973H1.86963L1.89227 7.79722C1.89249 7.80469 1.89261 7.81216 1.89261 7.81963C1.89261 8.36056 2.10749 8.87933 2.48998 9.26182C2.87248 9.64432 3.39125 9.8592 3.93218 9.8592C4.47311 9.8592 4.99188 9.64432 5.37437 9.26182C5.7491 8.8871 5.96295 8.38157 5.97148 7.85255L5.97133 7.81969V7.03973ZM2.1128 5.53973L3.05171 2.49976H15.973L16.9099 5.53973H2.1128Z" fill="#222222"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16.0176 18.4336C16.0176 18.4336 19.5176 16.0105 19.5176 12.8951C19.5176 11.9771 19.1488 11.0966 18.4925 10.4475C17.8361 9.79829 16.9458 9.43359 16.0176 9.43359C15.0893 9.43359 14.1991 9.79829 13.5427 10.4475C12.8863 11.0966 12.5176 11.9771 12.5176 12.8951C12.5176 16.0105 16.0176 18.4336 16.0176 18.4336ZM17.4177 12.8951C17.4177 13.6598 16.7909 14.2797 16.0177 14.2797C15.2445 14.2797 14.6177 13.6598 14.6177 12.8951C14.6177 12.1304 15.2445 11.5105 16.0177 11.5105C16.7909 11.5105 17.4177 12.1304 17.4177 12.8951Z" fill="#222222"></path>
                                        </svg>
                                        Find Stores</span>
                                </li>
                                <div class="search-bar px-5" id="searchBar">
                                    <i class="fa-solid fa-magnifying-glass mr-2" style={{ fontSize: "18px", }}></i>
                                    <input type="text" value={search} onChange={(e) => dispatch(setSearch(e.target.value.toUpperCase()))} placeholder="Search..." />
                                    ...
                                    (() => {
                                        if (localStorage.getItem('wid')) {
                                            return (
                                                <>
                                                    <li className="nav-item dropdown">
                                                        <NavLink className="nav-link dropdown-toggle" to="/profile" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Profile</NavLink>
                                                        <div className="dropdown-menu" aria-labelledby="dropdown04">
                                                            {/* <NavLink className="dropdown-item" to="/shop">Shop</NavLink> */}
                                                            <NavLink className="dropdown-item" to="/profile">View Profile</NavLink>
                                                            <Link className="dropdown-item" onClick={UserLogout}><i class="fa-solid fa-right-from-bracket"></i> LogOut</Link>
                                                        </div>
                                                    </li>
                                                </>
                                            )
                                ...
                                {
                                    banner && (
                                        <li className="nav-item cta cta-colored" ><a to="#" style={{ cursor: "pointer" }} onClick={handleOffcanvasToggle} className="nav-link"><span className="icon-shopping_cart" style={{ color: "#000" }} />[{totalQuantity}]</a></li>
                                    )
                                }
                            </ul>
                        </div>
