                    ...
                    <div className="row mb-5">
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4">
                                <h2 className="ftco-heading-2">Neeman's</h2>
                        ...
                        <div className="col-md">
                            <div className="ftco-footer-widget mb-4 ml-md-5">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li><NavLink to="/view_categories/1720610871389" className="py-2 d-block">Men</NavLink></li>
                                    <li><NavLink to="/view_categories/1720330610185" className="py-2 d-block">Women</NavLink></li>
